 ...
 */
export type LettermintMessageStatus =
	| "blocked"
	| "clicked"
	| "delivered"
	| "failed"
...
export interface LettermintAdapterBaseArgs {
	/**
...
export interface LettermintAdapterConstructionArgs {
	/**
...
export type LettermintAdapterArgs = LettermintAdapterBaseArgs &
	(
		| LettermintAdapterConstructionArgs
		| {
				/**
